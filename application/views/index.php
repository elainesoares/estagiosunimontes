...
<html>
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/bootstrap/dist/css/bootstrap-theme.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>assets/bootstrap/docs/examples/theme/theme.css" rel="stylesheet">

        <title>{AbaTitle}</title>
    </head>
    <body role="document">
