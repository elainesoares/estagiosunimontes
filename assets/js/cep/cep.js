...
function wscep(conf)
{
    ...
    if(wsconf.auto == true){
        ...
        var btn_busca = '<div class="control-group cep-label"><label class="control-label">CEP</label>';
        btn_busca += '<div class="controls">';
        btn_busca += '<input class="span3" id="cep" name="cep" type="text" maxlength="9" placeholder="Informe o CEP" /><button id="busca_cep" class="btn btn_handler" type="button" style="margin-left: -66px;">Busca</button></div>';
        btn_busca += '</div>';
